...
class CWMachine(StateMachine):
    ...
    def on_enter_dash(self):
        ...
        self.blueLight.blink(1.500,0,1,0)
    ...
    def toggleMessage(self):
        ...
        if(self.activeMessage == 'SOS'):
            self.activeMessage = 'OK'
        elif(self.activeMessage == 'OK'):
            self.activeMessage = 'SOS'
